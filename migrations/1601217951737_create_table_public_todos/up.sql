...
CREATE TABLE "public"."todos"("id" uuid NOT NULL DEFAULT gen_random_uuid(), "name" text NOT NULL, "body" text NOT NULL, "is_completed" boolean NOT NULL DEFAULT false, "user_id" uuid NOT NULL, "created_at" timestamptz NOT NULL DEFAULT now(), "updated_at" timestamptz NOT NULL DEFAULT now(), PRIMARY KEY ("id") , FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON UPDATE restrict ON DELETE restrict);
